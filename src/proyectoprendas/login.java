...
public class login extends javax.swing.JFrame {
     ...
     */
    public login() {
        this.setTitle("Entrar al reporte de prendas");
    ...
    private void initComponents() {
        ...
        buttonAcc.setBackground(new java.awt.Color(0, 0, 0));
        buttonAcc.setFont(new java.awt.Font("Segoe UI Black", 0, 14)); // NOI18N
        buttonAcc.setForeground(new java.awt.Color(255, 255, 255));
        buttonAcc.setText("ACEPTAR");
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addComponent(textPassword, javax.swing.GroupLayout.DEFAULT_SIZE, 321, Short.MAX_VALUE)))
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        .addGap(274, 274, 274)
    ...
    private void buttonAccActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonAccActionPerformed
        ...
        if(usuario.isEmpty() || contrasena.isEmpty()){
            ...
            if(usuario.equals("prendaModa") && contrasena.equals("1234")){
                JOptionPane.showMessageDialog(null, "Bienvenido al registro");
                    InspeccionDeMedidas Im = new InspeccionDeMedidas();
                    Im.setVisible(true);
                    this.setVisible(false);
            }else{
                JOptionPane.showMessageDialog(null, "Incorrecto el usuario o contraseña");
            }
        }
